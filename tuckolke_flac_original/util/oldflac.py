...
#        f.seek(offset)
#        vx = self._read_data(f, columns, count=self.nelements)
#        f.close()
#
#        f = open('vz.0')
#        offset = (frame-1) * columns * self.nelements * sizeoffloat
#        f.seek(offset)
#        vz = self._read_data(f, columns, count=self.nelements)
#        f.close()
#
#        self._reshape_elemental_fields(vx, vz)
#        return vx, vz
#
#
#    def read_temperature(self, frame):
...
#        offset = (frame-1) * columns * self.nelements * sizeoffloat
#        f.seek(offset)
#        T = self._read_data(f, columns, count=self.nelements)
#        self._reshape_elemental_fields(T)
#        return T
    ...
    def read_phase(self, frame):
        ...
        offset = (frame-1) * columns * self.nelements * sizeoffloat
        f.seek(offset)
        phase = self._read_data(f, columns, count=self.nelements)
