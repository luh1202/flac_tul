...
read(4,*) ny_inject, dike_depth, nelem_inject, rate_inject_brittle, rate_inject_ductile, inj_period, ext_period, inj_count
!read(4,*) ny_inject, dike_depth, rate_inject_brittle, rate_inject_ductile
call AdvanceToNextInputLine( 4 )
